Η εργασιά αυτή πραγματοποιήθηκε για το μάθημα "Ανάλυση Μεγάλων Δεδομένων μέσω της Γλώσσας Python" του μεταπτυχιακού προγράμματος "Ψηφιακά Μέσα Επικοινωνίας και Περιβάλλοντα Αλληλεπίδρασης" του ΕΚΠΑ
